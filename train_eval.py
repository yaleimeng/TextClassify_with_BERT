...
def file_based_input_fn_builder(input_file, seq_length, is_training,
    ...
    def input_fn(params):
        ...
        batch_size = FLAGS.train_batch_size  # params["batch_size"]
...
def main(_):
    ...
    num_train_steps = int(
        len(train_examples) / FLAGS.train_batch_size * FLAGS.num_train_epochs) if FLAGS.do_train else None
    num_warmup_steps = int(num_train_steps * FLAGS.warmup_proportion) if FLAGS.do_train else None
    ...
    if FLAGS.do_predict:
        predict_examples = processor.get_test_examples(FLAGS.data_dir)  # 待预测的样本们
